...
<head>
	...
	<meta name="keywords"
		content="sanskar events and celebrations, bride, ceremony, clean, couple, cute, event, gallery, girly, groom, guestbook, honeymoon, invitation, marriage, one page, rsvp, wedding, wedding events, wedding planner, wedding ">
	...
	<div class="wrapper">
		...
		<div class="header-top ulockd-bgthm">
			<div class="container">
				<div class="row">
					<div class="col-md-3">
						<div class="welcm-ht">
							<p class="ulockd-welcntxt  color-white"><strong>Call:</strong> +91 (9220) 228 691</p>
						</div>
					</div>
					<div class="col-md-6">
						<div class="welcm-ht">
							<p class="ulockd-welcntxt color-white text-center "><strong>Email:</strong>
								info@sanskarevents.in</p>
						</div>
					</div>
		...
		<header class="header-nav">
			<div class="main-header-nav navbar-scrolltofixed">
				<div class="container ulockd-pdng0 px-0">
